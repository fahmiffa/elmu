            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                <div class="mb-4">
                    ...
                    <select name="grade" required
                        ...
                        <option value="pra_tk" @selected($student->jenjang == 'pra_tk')>Pra TK</option>
                        <option value="tk" @selected($student->jenjang == 'tk')>TK</option>
                        <option value="sd" @selected($student->jenjang == 'sd')>SD</option>
                        <option value="smp" @selected($student->jenjang == 'smp')>SMP</option>
                        <option value="alumni" @selected($student->jenjang == 'alumni')>Alumni</option>
                    </select>
                    @error('grade')
