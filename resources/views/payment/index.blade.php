...
@section('content')
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="dataTable({{ json_encode($items) }})">
        ...
        <div class="mb-4 flex justify-between items-center gap-2">
            ...
            <a href="{{ route('dashboard.master.payment.create') }}"
                ...
                <thead>
                    <tr class="bg-orange-500 text-left text-white">
                        ...
                        <th @click="sortBy('name')" class="cursor-pointer px-4 py-2">Nama</th>
                         <th class="cursor-pointer px-4 py-2">Bulan</th>
                ...
                <tbody>
                    <template x-for="(row, index) in paginatedData()" :key="row.id">
                        <tr class="border-t border-gray-300">
                            ...
                            <td class="px-4 py-2" x-text="row.month"></td>
                            <td class="px-4 py-2 flex items-center gap-1">
                                <a :href="'/dashboard/master/payment/' + row.id + '/edit'"
                                ...
                                <form :action="'/dashboard/master/payment/' + row.id" method="POST"
