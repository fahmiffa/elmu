...
@section('content')
<div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="dataTable({{ json_encode($items) }})" x-init="exportModal = false">
            ...
            x-data="{
                ...
                pollStatus() {
                    ...
                    this.pollInterval = setInterval(() => {
                        tick++;
                        // Animasikan progress bar secara bertahap (maks 90 sebelum done)
