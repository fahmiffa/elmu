    ...
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6">
        <div x-data="{ tab: 'home' }">
            <div class="flex border-b border-gray-300">
                ...
                <button class="px-4 py-2 -mb-px text-sm font-medium border-b-2 cursor-pointer"
                    :class="tab === 'lay' ? 'border-orange-500 text-orange-600' :
                        'border-transparent text-gray-600 hover:text-orange-500'"
                    @click="tab = 'lay'">
                    LAYANAN
                </button>
            ...
            <div class="mt-4">
                <div x-show="tab === 'home'" x-transition x-data="dataTable({{ json_encode($kit) }})">
                    <div class="mb-4 flex justify-between items-center gap-2">
                        ...
                        <a href="{{ route('dashboard.master.layanan.kit') }}"
                ...
                <div x-show="tab === 'lay'" x-transition x-data="dataTable({{ json_encode($lay) }})">
                    <div class="mb-4 flex justify-between items-center gap-2">
                        <input type="text" x-model="search" placeholder="Cari Nama"
                            class="w-full md:w-1/2 border border-gray-300  ring-0 rounded-xl px-3 py-2 focus:outline-[#FF9966]" />
