...
<div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="materiForm({})">
    ...
    <form method="POST"
        ...
        <button type="submit" :disabled="uploading"
            class="bg-orange-500 text-white font-bold py-2 px-3  w-40 rounded-2xl hover:bg-orange-700 text-sm cursor-pointer">
            <span x-show="!uploading">Simpan</span>
            <span x-show="uploading">Mengupload... <span x-text="progress + '%'"></span></span>
        </button>
    </form>
</div>
@endsection