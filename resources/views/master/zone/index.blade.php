...
@section('content')
    <div class="flex flex-col bg-white rounded-lg shadow-md p-6" x-data="dataTable({{ json_encode($items) }})">
        ...
        <div class="mb-4 flex justify-between items-center gap-2">
            ...
            <a href="{{ route('dashboard.master.zone.create') }}"
                ...
                <tbody>
                    <template x-for="(row, index) in paginatedData()" :key="row.id">
                        <tr class="border-t border-gray-300">
                            ...
                            <td class="px-4 py-2">
                                    <ul>
                                        <template x-for="(col, index) in row.unit" :key="index">
                            ...
                            <td class="px-4 py-2">
                                <div class=" flex items-center gap-1">
                                    <a :href="'/dashboard/master/zone/' + row.id + '/edit'"
                                    ...
                                    <form :action="'/dashboard/master/zone/' + row.id" method="POST"
